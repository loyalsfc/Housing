                        ...
                        <form data-aos="fade-up" className='py-[52px] shadow-8xl rounded-[10px] px-4 sm:px-8 md:px-12 lg:px-[63px]'>
                            ...
                            <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-6'>
                                ...
                                <InputWrapper labelTitle="City">
                                    <div className='add-input flex items-center'>
                                        <select name="cities" id="cities" className="bg-transparent w-full">
                                ...
                                <InputWrapper labelTitle='State'>
                                    <div className='add-input flex items-center'>
                                        <select name="states" id="states" className='bg-transparent w-full'>
                                ...
                                <InputWrapper labelTitle="Room Type">
                                    <div className='add-input flex items-center'>
                                        <select name="room-type" id="room-type" className="bg-transparent w-full">
