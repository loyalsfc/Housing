...
function VideoSection() {
    ...
    const testimoniesSlider = Testimonies.map((item, index) => {
        return (
            <div 
                key={index} 
                className={`w-2.5 h-2.5 sliders rounded-full ${index == 0 ? 'bg-orange' : 'bg-[#D9DBE1]'}`}
    ...
    return (
        <section className='bg-orange/[0.07] flex justify-between items-center md:mb-[110px] gap-10 px-4  sm:px-6 md:px-0 py-[50px] md:py-0'>
